...
class GarminJrTrackerEntity(
    ...
    def __init__(
        ...
        self._cached_coords: tuple[float | None, float | None, str | None, int] = (
            None,
            None,
            None,
            15,
        )
        self._update_cached_coords()
    ...
    def _update_cached_coords(self) -> None:
        """Update cached zone coordinates calculation."""
        self._cached_coords = self._resolve_zone_coordinates()
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "matched_ha_zone": self._cached_coords[2],
